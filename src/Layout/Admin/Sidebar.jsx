        ...
        <ul className="space-y-2 font-medium">
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Promo</span>
            </Link>
          </li>
          <li>
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Activitities</span>
            </Link>
          </li>
          <li>
            <a
...
const Sidebar = ({children}) => {
  ...
  return (
    <div>
      ...
      <aside
        id="default-sidebar"
        className={`fixed top-14 left-0 z-40 w-64 h-screen transition-transform translate-x-0 sm:-translate-x-full ${sidebarVisible ? 'block' : 'hidden'}`}
        aria-label="Sidebar"
      >
        <ListMenu />
      </aside>
